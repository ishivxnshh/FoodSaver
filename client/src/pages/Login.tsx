    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 flex items-center justify-center px-4 py-12">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Sign in to continue to FoodSaver</p>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                type="button"
                className="flex items-center justify-center px-4 py-3 border border-slate-700 rounded-lg hover:bg-slate-800 transition-colors"
              >
